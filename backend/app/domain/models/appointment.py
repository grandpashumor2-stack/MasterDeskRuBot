...
class Appointment(Base):
    ...
    service_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("services.id", ondelete="SET NULL"))
    ...
    car_description: Mapped[Optional[str]] = mapped_column(String(500))
